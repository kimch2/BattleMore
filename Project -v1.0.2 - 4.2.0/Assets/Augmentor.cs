...
public class Augmentor : TargetAbility, Iinteract, Modifier {
	...
	public void Cast(){
		...
		else if (unitMan.UnitName.Contains("Yard") ||unitMan.UnitName == "Armory" ||unitMan.UnitName.Contains("Avi") || unitMan.UnitName.Contains("Avi") || unitMan.UnitName.Contains("Academy")|| unitMan.UnitName.Contains("Flux")  ) {
	...
	public void changeSpeed(float n)
	{
		...
		else if (unitMan.UnitName.Contains("Yard") ||unitMan.UnitName == "Armory" ||unitMan.UnitName.Contains("Lab") ||unitMan.UnitName.Contains("Avi") || unitMan.UnitName.Contains("Academy") || unitMan.UnitName.Contains("Flux") ) {
	...
	{if (!attached) {
		...
		if (OD) {
			OD.returnRate = 1;
		} else if (man.UnitName.Contains ("Yard") || man.UnitName == "Armory" || man.UnitName.Contains ("Lab") || man.UnitName.Contains ("Avi") || man.UnitName.Contains ("Academy")|| man.UnitName.Contains("Flux")) {
	...
	public void Dying()
	{
		if (attached) {
			UnitManager man = attached.GetComponent<UnitManager> ();
			if (man && (man.UnitName.Contains ("Yard") || man.UnitName == "Armory" || man.UnitName.Contains ("Lab") || man.UnitName.Contains ("Avi") || man.UnitName.Contains ("Academy")|| man.UnitName.Contains("Flux"))) {
